...
from flake8_2gis_style.errors import SleepWithConstantArgument
from flake8_2gis_style.visitors.call_checkers import SleepChecker
from flake8_2gis_style.visitors.function_call_visitor import FunctionCallVisitor
